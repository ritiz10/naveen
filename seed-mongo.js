...
const seedData = async () => {
    try {
        ...
        console.log('Seeding Real-Time News Data...');
        const articles = [
            {
                title: 'Top MNCs Recruits 50+ Students from PSR Engineering College',
                content: 'PSR Engineering College continues its streak of excellence in placements. Over 50 students from the 2026 batch have been placed in top-tier multinational companies with lucrative packages.',
                category: 'placements',
            ...
            },
            {
                ...
                content: 'The recent recruitment drive by Zoho Corporation at PSR Engineering College saw a massive turnout. After multiple rounds of rigorous testing and interviews, 15 talented students were selected.',
                category: 'placements',
                author: adminUser._id,
                views: 980,
            ...
            },
            {
                ...
                content: 'The campus is buzzing with energy as PSR\'s annual cultural extravaganza, SPARK 2026, officially begins today.',
                category: 'events',
                author: adminUser._id,
                views: 3200,
            ...
            },
            {
                ...
                content: 'PSR Engineering College recently hosted a three-day International Conference on Sustainable Energy and Environment.',
                category: 'events',
                author: adminUser._id,
                views: 850,
            ...
            },
            {
                ...
                content: 'To foster innovation in cutting-edge technologies, the Department of CSE at PSR has inaugurated a state-of-the-art AI & Robotics Lab.',
            ...
            },
            {
                ...
                content: 'The student team from the Mechanical Engineering department at PSR brought home the trophy at the National Level Baja Competition.',
                category: 'departments',
                author: adminUser._id,
                views: 740,
            ...
            },
            {
                ...
                content: 'The Controller of Examinations at PSR Engineering College has officially released the schedule for the upcoming even-semester examinations.',
                category: 'exams',
                author: adminUser._id,
                views: 5600,
            ...
            },
            {
                ...
                content: 'PSR Engineering College organized a comprehensive guidance session for students appearing for GATE 2027.',
                category: 'exams',
                author: adminUser._id,
                views: 1100,
            ...
            },
            {
                ...
                content: 'Continuing their dominance in sports, the PSR cricket team emerged victorious in the TNEB Zonal Cricket Championship.',
                category: 'sports',
                author: adminUser._id,
                views: 2100,
            ...
            },
            {
                ...
                content: 'The PSR Annual Sports Meet concluded with a grand prize distribution ceremony.',
                category: 'sports',
                author: adminUser._id,
                views: 1340,
            ...
            },
            {
                ...
                content: 'Final year students from PSR Engineering College have developed a low-cost Smart Irrigation System.',
                category: 'technology',
                author: adminUser._id,
                views: 1890,
            ...
            {
                title: 'Workshop on Blockchain Technology and Web3.0 Organised',
                content: 'The Information Technology department at PSR Engineering College organized a workshop on Blockchain and Web3.0.',
                category: 'technology',
                author: adminUser._id,
                views: 1200,
        ...
        console.log('Setup Complete! 12 PSR Articles and admin user migrated to MongoDB.');
        process.exit();
    } catch (error) {
